...
external_url: https://kubernetes.io/blog/2026/02/26/ccm-new-metric-route-sync-total/
post_kind: link
draft: false
tldr: 'Kubernetes v1.36: New Metric for Route Sync in the Cloud Controller Manager
  ...
  I give feedback? Kubernetes v1.36 introduces a new alpha counter metric route_controller_route_sync_total
  to the Cloud Controller Manager (CCM) route controller implementation at k8s. io/cloud-provider.'
summary: 'Kubernetes v1.36: New Metric for Route Sync in the Cloud Controller Manager
  A/B testing watch-based route reconciliation Example: expected behavior Where can
  I give feedback? Kubernetes v1.36 introduces a new alpha counter metric route_controller_route_sync_total
  to the Cloud Controller Manager (CCM) route controller implementation at k8s. io/cloud-provider.
  This metric increments each time routes are synced with the cloud provider. route_controller_route_sync_total
  ...
  is especially visible in stable clusters where nodes rarely change. If you have
  feedback, feel free to reach out through any of the following channels: The #sig-cloud-provider
  channel on Kubernetes Slack The KEP-5237 issue on GitHub The SIG Cloud Provider
  community page for other communication channels For more details, refer to KEP-5237.
  ← Previous Next →.'
---
Open the original post ↗ https://kubernetes.io/blog/2026/02/26/ccm-new-metric-route-sync-total/
