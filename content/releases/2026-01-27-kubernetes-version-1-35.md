---
title: Kubernetes version 1.35
date: '2026-01-27T19:00:00+00:00'
tags:
- eks
source: EKS Release Notes
external_url: https://docs.aws.amazon.com/eks/latest/userguide/kubernetes-versions.html#kubernetes-1-35
post_kind: release
draft: false
tldr: Understand the Kubernetes version lifecycle on EKS Available versions on standard
  ...
  page on GitHub link that is located in the right pane of every page. Register for
  upcoming Amazon EKS workshops.
summary: "Understand the Kubernetes version lifecycle on EKS Available versions on\
  ...
  \ right pane of every page. Register for upcoming Amazon EKS workshops. Kubernetes\
  \ rapidly evolves with new features, design updates, and bug fixes. The community\
  \ releases new Kubernetes minor versions (such as 1.33 ) on average once every four\
  \ months. Amazon EKS follows the upstream release and deprecation cycle for minor\
  \ versions. As new Kubernetes versions become available in Amazon EKS, we recommend\
  \ that you proactively update your clusters to use the latest available version.\
  \ 1.33 A minor version is under standard support in Amazon EKS for the first 14\
  \ months after itâ\x80\x99s released. Once a version is past the end of standard\
...
---
Open the original post ↗ https://docs.aws.amazon.com/eks/latest/userguide/kubernetes-versions.html#kubernetes-1-35
